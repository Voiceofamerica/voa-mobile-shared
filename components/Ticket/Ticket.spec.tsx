...
import OriginalTicket, { ArticleBlurb } from './Ticket'

const importModule = (): typeof OriginalTicket => {
...
describe('<Ticket />', () => {
  ...
  describe('snapshots', () => {
    it('renders correctly', () => {
      const Ticket = importModule()
      const tree = renderer.create(
        <Ticket onPress={jest.fn()} blurb={testArticle} />,
      )
  ...
  describe('button press', () => {
    it('should call onPress()', () => {
      ...
      const wrapper = shallow(
        <Ticket onPress={pressHandler} blurb={testArticle} />,
      )
